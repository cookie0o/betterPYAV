...
# Form implementation generated from reading ui file 'C:\Users\rapha\Downloads\PYAV_ui_raw\untitled.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(740, 340))
...
"};")
        ...
        self.scrollArea_2 = QtWidgets.QScrollArea(self.ResultsPage)
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 647, 235))
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        self.formLayout_4 = QtWidgets.QFormLayout(self.scrollAreaWidgetContents_2)
        self.formLayout_4.setContentsMargins(0, 0, 0, 5)
        ...
        self.verticalLayout_12.setContentsMargins(-1, -1, -1, 2)
        ...
        self.VirusTotalCheck_noInput_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setFamily("Alef")
        ...
        self.MetaDefenderCheck_noInput_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.HashCheck_noInput_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.horizontalLayout_14.addWidget(self.HashCheck_noInput_checkBox)
        self.MLCheck_noInput_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.MLCheck_noInput_checkBox.setFont(font)
        self.MLCheck_noInput_checkBox.setObjectName("MLCheck_noInput_checkBox")
        self.horizontalLayout_14.addWidget(self.MLCheck_noInput_checkBox)
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_14.addItem(spacerItem6)
        self.verticalLayout_12.addLayout(self.horizontalLayout_14)
        self.formLayout_4.setLayout(1, QtWidgets.QFormLayout.FieldRole, self.verticalLayout_12)
        ...
        self.HashCheckDetection_noInput_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.MLCheckDetection_noInput_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.MLCheckDetection_noInput_checkBox.setFont(font)
        self.MLCheckDetection_noInput_checkBox.setObjectName("MLCheckDetection_noInput_checkBox")
        self.horizontalLayout.addWidget(self.MLCheckDetection_noInput_checkBox)
        ...
        self.VirusTotal_harmless_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.VirusTotal_malicious_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.VirusTotal_suspicious_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.VirusTotal_timeout_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.VirusTotal_unsupported_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.VirusTotal_undetected_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.VirusTotal_failure_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.formLayout_4.setLayout(4, QtWidgets.QFormLayout.FieldRole, self.verticalLayout_8)
        ...
        self.MetaDefender_EngineDetections_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.MetaDefender_Engines_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.MetaDefender_DetectionPercentage_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.MetaDefender_UserVotesMalicious_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.MetaDefender_UserVotesHarmless_results_label = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.formLayout_4.setLayout(5, QtWidgets.QFormLayout.FieldRole, self.verticalLayout_9)
        ...
        self.formLayout_4.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.label_36)
        self.line = QtWidgets.QFrame(self.scrollAreaWidgetContents_2)
        self.line.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line.setLineWidth(2)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setObjectName("line")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.line)
        self.line_2 = QtWidgets.QFrame(self.scrollAreaWidgetContents_2)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_2.setLineWidth(2)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setObjectName("line_2")
        self.formLayout_4.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.line_2)
        spacerItem8 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.formLayout_4.setItem(0, QtWidgets.QFormLayout.FieldRole, spacerItem8)
        self.scrollArea_2.setWidget(self.scrollAreaWidgetContents_2)
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.SpanningRole, self.scrollArea_2)
...
"};")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 656, 262))
        ...
        self.formLayout.setItem(0, QtWidgets.QFormLayout.FieldRole, spacerItem10)
        ...
        self.theme_comboBox.addItem("")
        self.theme_comboBox.addItem("")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.theme_comboBox)
        ...
        self.KeepWindowSizeOnRestart_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.KeepWindowSizeOnRestart_checkBox.setFont(font)
        self.KeepWindowSizeOnRestart_checkBox.setObjectName("KeepWindowSizeOnRestart_checkBox")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.KeepWindowSizeOnRestart_checkBox)
        ...
        self.VirusTotal_ApiKey_lineEdit = QtWidgets.QLineEdit(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.VirusTotal_ApiKey_lineEdit)
        ...
        self.MetaDefender_ApiKey_lineEdit = QtWidgets.QLineEdit(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.MetaDefender_ApiKey_lineEdit)
        ...
        self.UpdateHashes_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.UpdateInterval_timeEdit = QtWidgets.QTimeEdit(self.scrollAreaWidgetContents)
        ...
        self.Method_HashCheck_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.Method_VirusTotal_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.Method_MetaDefender_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.Method_MLCheck_checkBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.Method_MLCheck_checkBox.setFont(font)
        self.Method_MLCheck_checkBox.setObjectName("Method_MLCheck_checkBox")
        self.horizontalLayout_13.addWidget(self.Method_MLCheck_checkBox)
        spacerItem14 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_13.addItem(spacerItem14)
        self.verticalLayout_11.addLayout(self.horizontalLayout_13)
        self.formLayout.setLayout(5, QtWidgets.QFormLayout.FieldRole, self.verticalLayout_11)
...
"};")
        ...
        self.gridLayout_4.addWidget(self.SaveSettings_pushButton, 0, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.MLCheck_noInput_checkBox.setText(_translate("MainWindow", "ML Check"))
        ...
        self.MLCheckDetection_noInput_checkBox.setText(_translate("MainWindow", "ML Check"))
        ...
        self.label_34.setText(_translate("MainWindow", "WARNING:"))
        self.label_36.setText(_translate("MainWindow", "ML checks are not designed to definitively determine if a file is a virus and can give false positives!"))
        ...
        self.label_30.setText(_translate("MainWindow", "Window Size"))
        self.KeepWindowSizeOnRestart_checkBox.setText(_translate("MainWindow", "Keep size on restart"))
        ...
        self.Method_MLCheck_checkBox.setText(_translate("MainWindow", "ML Check"))
