...
# import outside functions etc
from dep.py.functions import openLinkDialog, changePage, FileDialog, ErrorBox
from dep.py.settingsfunc import Load_settings, SaveApply_settings
...
class Ui_MainWindow(object):
    ...
    def HashUpdateTread(self, current_dir):
        ...
        self.timer.setInterval(_UserDefinedInterval)
        # start the timer
        self.timer.start()
    ...
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.ReportAIssue_pushButton, 1, 0, 1, 1)
...
"};")
        ...
        self.FilePathDisplay_label = QtWidgets.QLabel(self.ResultsPage)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.FilePathDisplay_label.setFont(font)
        self.FilePathDisplay_label.setObjectName("FilePathDisplay_label")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.FilePathDisplay_label)
        ...
        self.HashDisplay_label = QtWidgets.QLabel(self.ResultsPage)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.HashDisplay_label.setFont(font)
        self.HashDisplay_label.setObjectName("HashDisplay_label")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.HashDisplay_label)
        ...
        self.formLayout_3.setLayout(6, QtWidgets.QFormLayout.FieldRole, self.verticalLayout_8)
...
"};")
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.SaveSettings_pushButton)
        ...
        self.formLayout.setItem(6, QtWidgets.QFormLayout.LabelRole, spacerItem10)
        ...
        self.ScanAFile_pushButton.clicked.connect(lambda: (
            self.changePage("LoadingPage", "scanning"),
            self.scan(current_dir, FileDialog(self, MainWindow), "singleFile")
        ))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.FilePathDisplay_label.setText(_translate("MainWindow", "None"))
        self.label_6.setText(_translate("MainWindow", "Hash:"))
        self.HashDisplay_label.setText(_translate("MainWindow", "None"))
        ...
        self.Method_VirusTotal_checkBox.setText(_translate("MainWindow", "Virus Total Hash Check"))
